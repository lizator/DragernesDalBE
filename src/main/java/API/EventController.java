...
public class EventController {
    ...
    public List<AttendingDTO> getAllAttending(@PathVariable int charID) {
        return daoA.getAllAttending(charID);
    }
    ...
    @PostMapping(value = "/event/add/ep", consumes = "application/json", produces = "application/json")
    public CheckInDTO addEP(@RequestBody CheckInDTO dto) {
        return daoC.addEP(dto);
    }
